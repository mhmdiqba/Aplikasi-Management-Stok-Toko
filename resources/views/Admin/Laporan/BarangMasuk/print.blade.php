...
<body onload="window.print()">
    ...
    <center>
        @if($web->web_logo == '' || $web->web_logo == 'c:\Users\Victus\Downloads\Logo-SRC-Sampoerna-Retail-Community-1024x640.png')
        <img src="{{url('/assets/default/web/default.png')}}" width="120px" alt="">
        @else
        <img src="{{asset('storage/web/' . $web->web_logo)}}" width="120px" alt="">
        @endif
    </center>
